...
В следующем уроке мы разберём Обновления и удаления — как Iceberg выполняет операции `UPDATE` и `DELETE`, сохраняя при этом неизменяемость данных и поддерживая `time travel`.
