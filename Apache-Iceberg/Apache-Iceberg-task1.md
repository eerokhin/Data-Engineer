...
Должны увидеть два снапшота — по одному на каждый `INSERT`-запрос. Это основа `time travel`: каждая операция записи создаёт неизменяемый снапшот состояния таблицы.
...
<img width="1056" height="254" alt="image" src="https://github.com/user-attachments/assets/444b691c-a694-4521-86b2-83a110012713" />
...
<img width="459" height="60" alt="image" src="https://github.com/user-attachments/assets/3bfc50ad-b13a-4d21-aa3f-8def4651d91b" />
...
<img width="659" height="153" alt="image" src="https://github.com/user-attachments/assets/14ecd547-ada4-4274-9ee5-dd6c2d407c24" />
...
Далее изучим `ACID`‑транзакции — как `Iceberg` обеспечивает атомарность, изоляцию и консистентность при работе с несколькими писателями.
